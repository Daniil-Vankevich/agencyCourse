...
<body class="relative">
  ...
  <div class="main-wrapper oh">
    ...
    <header class="nav-type-1 dark-nav">
      ...
      <nav class="navbar navbar-fixed-top " style="<?php echo is_admin_bar_showing() ? 'top: 32px' : ''; ?>">
          ...
          <div class="row">
            ...
            <aside class="col-md-3 sidebar">
              ...
              <div class="widget custom-ad-banner">
                <a href="#">
                  <img src="<?php echo get_stylesheet_directory_uri() ?>/assets/img/banner.jpg" alt="">
                </a>
              </div>
                  ...
                  <ul class="posts-list list-dividers">
                    <li class="entry-li">
                      <article class="post-small clearfix">
                        <div class="entry-img">
                          <a href="blog-single.html">
                            <img src="<?php echo get_stylesheet_directory_uri() ?>/assets/img/recent_1.jpg" alt="">
                          </a>
                        </div>
                        <div class="entry">
                    ...
                    <li class="entry-li">
                      <article class="post-small clearfix">
                        <div class="entry-img">
                          <a href="blog-single.html">
                            <img src="<?php echo get_stylesheet_directory_uri() ?>/assets/img/recent_2.jpg" alt="">
                          </a>
                        </div>
                        <div class="entry">
                    ...
                    <li class="entry-li">
                      <article class="post-small clearfix">
                        <div class="entry-img">
                          <a href="blog-single.html">
                            <img src="<?php echo get_stylesheet_directory_uri() ?>/assets/img/recent_3.jpg" alt="">
                          </a>
                        </div>
                        <div class="entry">
                    ...
                    <li class="entry-li">
                      <article class="post-small clearfix">
                        <div class="entry-img">
                          <a href="blog-single.html">
                            <img src="<?php echo get_stylesheet_directory_uri() ?>/assets/img/recent_4.jpg" alt="">
                          </a>
                        </div>
                        <div class="entry">
